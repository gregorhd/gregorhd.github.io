...
paginate: true
---
_This is the first in a three part series telling the  story of Nakuru's urban expansion using different technologies. Part 1 looks at the most basic kind of medium, a timeseries of thematic maps distributed like any traditional cartographic product in the form of static maps. The tools used here are, unfortunately, for-pay though Parts 2 and 3 will then turn towards Google Earth Engine (free) and some of my favourite interactive visualisation libraries in the Python ecosystem (free and open-source)._
